...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (typeof gtag === 'function') {
      gtag('event', 'conversion', { send_to: 'AW-963639553/LV06COrHu7oaEIHyv8sD' });
    }
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      >
        ...
        >
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold mb-6">Contact Us</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <a href="tel:+919434280628" className="bg-cream hover:bg-sage/20 p-8 rounded-2xl text-center transition-all duration-300 hover:shadow-lg group">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
                <i className="ri-phone-line text-3xl text-gold" />
              </div>
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="bg-cream hover:bg-sage/20 p-8 rounded-2xl text-center transition-all duration-300 hover:shadow-lg group">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
                <i className="ri-whatsapp-line text-3xl text-gold" />
              </div>
            ...
            <a href="mailto:dewdale.resorts@gmail.com" className="bg-cream hover:bg-sage/20 p-8 rounded-2xl text-center transition-all duration-300 hover:shadow-lg group">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition-colors">
                <i className="ri-mail-line text-3xl text-gold" />
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl">
              <h2 className="font-serif text-3xl font-bold text-forest-dark mb-6">Send us a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-2">Check-in Date</label>
                    <input
                      type="date"
                      name="checkIn"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-2">Check-out Date</label>
                    <input
                      type="date"
                      name="checkOut"
            ...
            <div className="space-y-8" ref={infoRef}>
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gold/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <i className="ri-map-pin-line text-2xl text-gold" />
                  </div>
                  <div>
                    <h3 className="font-serif text-xl font-bold text-forest-dark mb-3">Our Location</h3>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gold/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <i className="ri-time-line text-2xl text-gold" />
                  </div>
                  <div>
                    <h3 className="font-serif text-xl font-bold text-forest-dark mb-3">Reception Hours</h3>
              ...
              <div className="bg-sage/10 rounded-3xl p-8 h-64 flex items-center justify-center">
                <div className="text-center">
                  <i className="ri-map-2-line text-5xl text-sage/40 mb-4" />
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-forest-dark mb-4">How to Reach</h2>
            <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">Your journey to paradise starts here</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-cream rounded-3xl p-8 hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mb-6">
                <i className="ri-flight-takeoff-line text-3xl text-gold" />
              </div>
            ...
            <div className="bg-cream rounded-3xl p-8 hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mb-6">
                <i className="ri-car-line text-3xl text-gold" />
              </div>
      ...
      <section className="py-20 bg-forest-dark text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-4xl font-bold mb-6">Ready to Experience Paradise?</h2>
          <p className="text-lg mb-8 text-white/80 max-w-2xl mx-auto">
            Contact us now and let us help you plan your perfect island getaway
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:+919434280628" className="bg-gold hover:bg-gold/90 text-forest-dark px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-lg flex items-center gap-2">
              <i className="ri-phone-line" />
              Call Now
            </a>
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-white/90 text-forest-dark px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:shadow-lg flex items-center gap-2">
      ...
      <section className="py-20 bg-sage/5">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-serif text-4xl font-bold text-center text-forest-dark mb-12">Quick answers to common questions</h2>
          <div className="space-y-6">
            {faqs.map((faq) => (
              <details key={faq.q} className="bg-white rounded-2xl p-6 shadow-md group">
                <summary className="font-semibold text-forest-dark cursor-pointer flex items-center justify-between">
                  {faq.q}
                  <i className="ri-arrow-down-s-line text-2xl group-open:rotate-180 transition-transform" />
                </summary>
                <p className="mt-4 text-charcoal/80 leading-relaxed whitespace-pre-line">{faq.a}</p>
              </details>
            ))}
          </div>
        </div>
